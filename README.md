# MusyFit V11.2.2 — Correção de inicialização
...
## Correção V11.2.2 — dados iniciais
- Nome, idade, dias por semana e minutos por treino passam a ser salvos como rascunho em cada digitação.
- Os campos não dependem mais apenas do clique em “Criar meu plano”.
- Se o WebView redesenhar a tela ou o usuário alternar opções, os valores são restaurados automaticamente.
- Nenhuma alteração na biblioteca de exercícios, treinos, IMC, Musy Progress ou Musy Coach.
